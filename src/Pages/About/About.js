...
const About = () => {
    return (
        <div id="about" className='flex flex-row container mx-auto'>
            ...
            <div className='aboutMe basis-2/4 p-10'> 
                ...
                <p className='pb-5'>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
                ...
                <h2 className='text-2xl py-5'><span className='text-primary font-bold'>12</span> Projects Complete</h2>

                <button className='btn btn-primary rounded-full'><a href="https://drive.google.com/file/d/1Pue-VnLk-WyJRhShobMSbjMXeq-vEa3n/view?usp=sharing" target="_blank">Download Resume</a></button>
            </div>
